...
func + (left: Int8, right: Int16) -> Int8 {
    ...
    return l.decimalNumberByAdding(r).charValue
}
...
func + (left: Int16, right: Int8) -> Int16 {
    ...
    return l.decimalNumberByAdding(r).shortValue
}
...
func + (left: Int32, right: Int8) -> Int32 {
    ...
    return l.decimalNumberByAdding(r).intValue
}
...
func + (left: Int64, right: Int8) -> Int64 {
    ...
    return l.decimalNumberByAdding(r).longLongValue
}
